...
## Project Structure
    ...
    ├── deploy_test_wj_dev_37485  # Django project configurations
...
1. Clone this repo and `cd deploy_test_wj_dev_37485`
...
2. Clone this repo and `cd deploy_test_wj_dev_37485`
